...
public class InputStateT9abc extends PredictiveInputMode{

    private static final InputMode.InputStates currentInputStateEnum =
            InputMode.InputStates.INPUT_STATE_T9abc;
    private static final int mStatusBarIcon = R.drawable.ic_stat_notify_xt9_unshifted;
    ...
    public InputStateT9abc(IInputModeCallback cb){
        super(cb);
